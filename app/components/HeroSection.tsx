      ...
      <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="space-y-12 order-2 lg:order-1">
          ...
          <div className="space-y-6 animate-fade-in-up delay-400">
            <h1 className="text-6xl sm:text-7xl lg:text-8xl font-extralight leading-none tracking-tight">
          ...
          {/* Description */}
          <p className="text-xl text-gray-500 leading-relaxed max-w-lg font-light animate-fade-in-up delay-600">
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 pt-8 animate-fade-in-up delay-1000">
            <div>
            ...
            <div>
              <div className="text-4xl font-light text-gray-900 mb-1">10K+</div>
        ...
        <div className="relative order-1 lg:order-2 animate-fade-in-up delay-400">
          <div className="relative">
            {/* Glass Card */}
            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-white/40 backdrop-blur-sm border border-white/60 p-3">
              <div className="h-[450px] sm:h-[550px] lg:h-[650px] rounded-2xl overflow-hidden">
                <ImageCarousel />
              </div>
            </div>
